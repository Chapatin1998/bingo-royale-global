// =================================================================
// BINGO VIP BOLIVIA - CÓDIGO MAESTRO COMPLETO v7 (EL DEFINITIVO)
// =================================================================
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (gameContainer) {
        ...
        if(callBallButton) callBallButton.addEventListener('click', callNextBall);
        initGame();
    }
...
onAuthStateChanged(auth, async (user) => {
    ...
    if (user) {
        ...
        try {
            ...
            // Si el perfil NO existe, lo mandamos a crearlo
            if (!docSnap.exists() && currentPage !== 'complete-profile.html') {
                window.location.href = 'complete-profile.html';
                return;
            }

            // Si el perfil SÍ existe y está en una página pública, lo mandamos al lobby
            if (docSnap.exists() && publicPages.includes(currentPage)) {
                 window.location.href = 'lobby.html';
                 return;
            }

            // Si está en el lobby, mostramos su info
            ...
            // Si está en la billetera, mostramos su saldo
